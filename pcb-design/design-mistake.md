...
7 years ago, our company made an 6-layer, high density Motor controller PCB design to the Fab. Unknowingly, there was an 8 mil via between EPAD and pin pad.&#x20;
...
The Fab engineers shirnked EPAD and Via size so that the IC chip does not short GND and SIGNAL&#x20;
...
However, Fab #2 proceeded with our design. Once we got 250 new boards, most of them had an differential signal shorted to the GND, burning the encoder differential driver.&#x20;
...
It was 2026 that we found out that there was a via between EPAD and signal pad.&#x20;
