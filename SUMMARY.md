...
## Machine Learning in Microcontroller

* [Edge Impulse](README.md)
* [Create Onnx and TensorRT](machine-learning-in-microcontroller/create-onnx-and-tensorrt.md)
* [How to make ML Dataset using Microsoft Vott: Implementation in Google Coral TPU](machine-learning-in-microcontroller/how-to-make-ml-dataset-using-microsoft-vott.md)
* [EMG-CV fusion Exoglove Control & PID Ball-Balancer](machine-learning-in-microcontroller/emg-cv-fusion-exoglove-control-and-pid-ball-balancer.md)

## PCB Design

* [USB-C PD Test Board](pcb-design/usb-c-pd-test-board.md)
...
* [JPG to JPEG](jpg-to-jpeg.md)
* [Making Battery Pack](making-battery-pack.md)
